                            ...
                            <div className="flex-1 min-w-0 w-full">
                                ...
                                <div className="flex items-baseline gap-1 mt-0.5 sm:mt-1">
                                    <p className="text-slate-900 dark:text-white font-black text-sm sm:text-lg truncate">
                                        {metric === 'orders' 
                                            ? data.reduce((a, b: any) => a + (b[metric] || 0), 0)
                                            : `$${data.reduce((a, b: any) => a + (b[metric] || 0), 0).toLocaleString(undefined, { maximumFractionDigits: 0 })}`
                                        }
                                    </p>
                                    <span className="text-slate-400 dark:text-slate-600 text-[9px] sm:text-[10px] font-bold">total</span>
                                </div>
                            </div>
                        </button>
                    );
