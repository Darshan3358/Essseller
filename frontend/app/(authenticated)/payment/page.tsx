        ...
        <>
            <div className="max-w-4xl mx-auto space-y-8 relative">
                ...
                <div className="space-y-3">
                    ...
                    <h2 className="text-3xl md:text-5xl font-black text-gray-900 tracking-tight leading-none bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 uppercase">Wallet Recharge</h2>
                        {user.verified === 1 && (
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-6">
                    {[
                        { key: 'supplier', label: 'Main Wallet', desc: 'Recharge your primary wallet for daily operations.', Icon: Wallet, color: 'blue' },
                        { key: 'vault', label: 'Guarantee Wallet', desc: 'Top up your secure guarantee/vault balance.', Icon: ShieldCheck, color: 'indigo' },
