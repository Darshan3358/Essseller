                ...
                <section className="relative overflow-hidden group">
                    ...
                    <div className="relative z-10 p-4 sm:p-10 lg:p-14 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-10 text-center md:text-left">
                        ...
                        <div className="relative animate-float-premium">
                            <div className="glass-card !bg-white/98 dark:!bg-slate-900/98 border-white/50 dark:border-slate-800/50 p-4 sm:p-7 w-full max-w-[220px] sm:max-w-none backdrop-blur-3xl shadow-[0_25px_60px_rgba(0,0,0,0.13)] rotate-2 hover:rotate-0 transition-all duration-700 relative overflow-hidden group/card" style={{ width: undefined }}>
                                {/* Top accent bar */}
