        ...
        <Shell>
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex items-center gap-4 mb-8">
                    <button onClick={() => router.push('/payment')} className="p-2 bg-white rounded-xl shadow-sm hover:scale-105 transition-all">
                        <ArrowLeft className="w-5 h-5 text-gray-500" />
                    </button>
                    <div>
                        <h2 className="text-2xl font-black text-gray-900 tracking-tight">Full Transaction History</h2>
                        <p className="text-xs text-gray-500 font-medium mt-1">View all your past payment transactions</p>
                    </div>
                </div>
