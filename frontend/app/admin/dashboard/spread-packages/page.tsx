...
import { Sparkles, RefreshCw, Edit2, Trash2, Plus, X, Save, Box, CheckCircle2, Star, History } from 'lucide-react';
        ...
        <div style={{ padding: '32px', color: 'white' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                    <button
                        onClick={() => router.push('/admin/dashboard/spread-packages/purchases')}
                        style={{
                    ...
                    >
                        <History size={18} /> View Purchases
                    </button>
                    <button
